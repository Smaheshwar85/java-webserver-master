...
sh(script: command, returnStdout: true).trim()
                 ...
                 sh "docker tag gcr.io/alert-result-396707/java-webserver us-central1-docker.pkg.dev/alert-result-396707/repositoryname/gcr.io/alert-result-396707/java-webserver"
                  sh "docker push us-central1-docker.pkg.dev/alert-result-396707/repositoryname/gcr.io/alert-result-396707/java-webserver"
